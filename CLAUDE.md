...
| Source       | id, url, token, name, description, enabled, lastFetched, lastError, version, scripts|
| SourceScript | id, name, code, type, enabled, autoRun, runAt, domains, paths, sourceId             |
